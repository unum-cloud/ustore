...
JNIEXPORT jobject JNICALL Java_com_unum_ukv_DataBase_transaction(JNIEnv* env_java, jobject db_java) {
    ...
    jclass txn_class_java = (*env_java)->FindClass(env_java, "com/unum/ukv/Transaction");
    ...
    jfieldID db_ptr_field = find_db_ptr_field(env_java, txn_java);
    jfieldID txn_ptr_field = find_txn_ptr_field(env_java, txn_java);
